...
public class CasoMapeador {
  ...
  public CasoRespuestaDto aRespuesta(CasoEntidad entity) {
    return CasoRespuestaDto.builder()
        ...
        .reporteTipo(entity.getReporteOrigen().getTipo().getNombre())
        .reporteZona(entity.getReporteOrigen().getZona())
        .reporteDescripcion(entity.getReporteOrigen().getDescripcion())
        .reporteFechaCreacion(entity.getReporteOrigen().getFechaCreacion())
