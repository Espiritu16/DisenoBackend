...
--
-- Table structure for table `alerta_servicio`
--

DROP TABLE IF EXISTS `alerta_servicio`;
CREATE TABLE `alerta_servicio` (
...
--
-- Table structure for table `lectura_iot`
--

DROP TABLE IF EXISTS `lectura_iot`;
CREATE TABLE `lectura_iot` (
...
--
-- Table structure for table `alerta_iot`
--

DROP TABLE IF EXISTS `alerta_iot`;
CREATE TABLE `alerta_iot` (
...
CREATE TABLE `usuario` (
  ...
  `rol` enum('CIUDADANO','ADMIN','OPERADOR','AUTORIDAD') COLLATE utf8mb4_unicode_ci NOT NULL,
